...
class EdgeCreator:
    ...
    def find_next_connection(self, json_object):
        ...
        if not next_json_object:
            ...
            (
                ...
                previous_json_object_command_id,
            ) = previous_json_object
    ...
    def create_connection(self, json_object):
        ...
        if "command" in json_object:
            if (
                object_type == "If.test"
                or object_type == "If.body"
                or object_type == "If.else"
                or object_type == "Assign"
            ):
                self.connections[json_object["id"]] = self.find_next_connection(
                    json_object
                )
    ...
    def create_edges(self):
        ...
        for key, value in self.connections.items():
            ...
            self.edges.append(Edge(source_node=source_node, target_node=target_node))
    ...
    def visualise_edges(self):
        ...
        for node in self.all_nodes:
            ...
            item = {"data": {"id": node["id"], "label": label}}
