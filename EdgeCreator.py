            ...
            if indentation_item.data['id'] == json_object['id']:
                if indentation_item.indentation_level >= 1:
                    for inner_indentation_item in self.all_indentation_items[::-1]:
                        if inner_indentation_item.command_number < indentation_item.command_number and \
                                inner_indentation_item.indentation_level == indentation_item.indentation_level - 1:
                            self.parents[json_object['id']] = inner_indentation_item.data
                            break
                    ...
                    if connection:
                        ...
                        for from_json_object_id, parent in self.parents.items():
                            if from_json_object_id == json_object_id:
                                connection_detail['parent'] = parent['id']
